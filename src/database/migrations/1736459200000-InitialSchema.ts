...
export class InitialSchema1736459200000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      CREATE INDEX IF NOT EXISTS idx_vaccinations_flock ON vaccinations(flock_id);
      ...
      CREATE INDEX IF NOT EXISTS idx_feeding_flock ON feeding_schedules(flock_id);
      ...
      CREATE INDEX IF NOT EXISTS idx_feeding_records_flock ON feeding_records(flock_id);
