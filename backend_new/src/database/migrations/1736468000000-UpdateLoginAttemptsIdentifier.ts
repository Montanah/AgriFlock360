...
export class UpdateLoginAttemptsIdentifier1736468000000
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS idx_login_attempts_email_time ON login_attempts(identifier, created_at DESC);`,
    );
