...
export class SubscriptionTables1764712047600 implements MigrationInterface {
  name = 'SubscriptionTables1764712047600';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "batchs" ADD "age" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "batchs" ADD "birds_alive" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "batchs" ADD "current_weight" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
      `ALTER TABLE "batchs" ADD "expected_weight" integer NOT NULL DEFAULT 0`,
    );
    await queryRunner.query(
