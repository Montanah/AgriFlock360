...
async function seedPermissions(queryRunner: QueryRunner): Promise<void> {
  ...
  const defaultPermissions = [
    ...
    // Permissions module
    { name: 'permissions.create', description: 'Create permissions', module: 'permissions', action: 'create' },
    { name: 'permissions.read', description: 'Read permissions', module: 'permissions', action: 'read' },
    { name: 'permissions.update', description: 'Update permissions', module: 'permissions', action: 'update' },
    { name: 'permissions.delete', description: 'Delete permissions', module: 'permissions', action: 'delete' },
    { name: 'permissions.manage', description: 'Manage permissions', module: 'permissions', action: 'manage' },
    // Devices module
    { name: 'devices.create', description: 'Create devices', module: 'devices', action: 'create' },
    { name: 'devices.read', description: 'Read devices', module: 'devices', action: 'read' },
    { name: 'devices.update', description: 'Update devices', module: 'devices', action: 'update' },
    { name: 'devices.delete', description: 'Delete devices', module: 'devices', action: 'delete' },
    { name: 'devices.manage', description: 'Manage devices', module: 'devices', action: 'manage' },
    // Flocks module
    { name: 'flocks.create', description: 'Create flocks', module: 'flocks', action: 'create' },
    { name: 'flocks.read', description: 'Read flocks', module: 'flocks', action: 'read' },
    { name: 'flocks.update', description: 'Update flocks', module: 'flocks', action: 'update' },
    { name: 'flocks.delete', description: 'Delete flocks', module: 'flocks', action: 'delete' },
    { name: 'flocks.manage', description: 'Manage flocks', module: 'flocks', action: 'manage' },
    // Farms module
    { name: 'farms.create', description: 'Create farms', module: 'farms', action: 'create' },
    { name: 'farms.read', description: 'Read farms', module: 'farms', action: 'read' },
    { name: 'farms.update', description: 'Update farms', module: 'farms', action: 'update' },
    { name: 'farms.delete', description: 'Delete farms', module: 'farms', action: 'delete' },
    { name: 'farms.manage', description: 'Manage farms', module: 'farms', action: 'manage' },
    // Reports module
    { name: 'reports.create', description: 'Create reports', module: 'reports', action: 'create' },
    { name: 'reports.read', description: 'Read reports', module: 'reports', action: 'read' },
    ...
    { name: 'reports.manage', description: 'Manage reports', module: 'reports', action: 'manage' },
    // Uploads module
    { name: 'uploads.create', description: 'Create uploads', module: 'uploads', action: 'create' },
    { name: 'uploads.read', description: 'Read uploads', module: 'uploads', action: 'read' },
    { name: 'uploads.update', description: 'Update uploads', module: 'uploads', action: 'update' },
    { name: 'uploads.delete', description: 'Delete uploads', module: 'uploads', action: 'delete' },
    { name: 'uploads.manage', description: 'Manage uploads', module: 'uploads', action: 'manage' },
    // System module
    { name: 'system.admin', description: 'Full system administration access', module: 'system', action: 'admin' },
    // Special permissions
    { name: 'users.impersonate', description: 'Impersonate other users', module: 'users', action: 'impersonate' },
  ];

  for (const perm of defaultPermissions) {
    let existingPermission = await permissionRepository.findOne({ where: { name: perm.name } });
...
async function seedRoles(queryRunner: QueryRunner): Promise<void> {
  ...
  for (const roleData of defaultRoles) {
    const existingRoleCount = await queryRunner.manager.query('SELECT COUNT(*) FROM roles WHERE name = $1', [roleData.name]);
